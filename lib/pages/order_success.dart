                  ...
                  child: CustomScrollView(slivers: <Widget>[
                    ...
                    SliverList(delegate: SliverChildBuilderDelegate(
                      ...
                      return Center(
                          child: Column(
                        children: [
                          Image.asset('images/order_success_icon.png', width: 150, height: 150,),
                          n.NikuText(
                          ...
                          n.NikuText(
                            '№${order.id}',
                            style: n.NikuTextStyle(
                                fontSize: 50, color: AppColors.green),
                          ),
                          n.NikuText(
                            DateFormat('d MMM, Hm')
                                .format(DateTime.parse(order.createdAt!)),
                            style:
                                n.NikuTextStyle(fontSize: 16, color: Colors.grey),
                          ),
                          const SizedBox(
                            height: 60,
                          ),
                          SizedBox(width: double.infinity,child: n.NikuButton(n.NikuText(
