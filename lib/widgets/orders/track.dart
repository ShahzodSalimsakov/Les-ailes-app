...
class _TrackOrderState extends State<TrackOrder> {
  ...
  Future<void> loadLocation(Timer timer) async {
    ...
    var url = Uri.https('api.lesailes.uz', '/api/orders/track/',
        ...
        setState(() {
          mapObjects = [
            ...
            PlacemarkMapObject(
              ...
              icon: PlacemarkIcon.single(PlacemarkIconStyle(
                  image: BitmapDescriptor.fromAssetImage(
                      'images/map_placemark-courier.png'))),
            ),
            PlacemarkMapObject(
                ...
                ? Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            tr('orderTracking.error_label').toUpperCase(),
                      ...
                      Text(
                        tr("orderTracking.${trackPoint!.message}"),
