...
class BasketStateFullWidget extends StatefulWidget {
  const BasketStateFullWidget({Key? key}) : super(key: key);

  @override
  State<BasketStateFullWidget> createState() => _BasketStateFullWidgetState();
}

class _BasketStateFullWidgetState extends State<BasketStateFullWidget> {
  bool _isOrderLoading = false;
  BasketData? basketData;
  List<RelatedProduct> relatedData = [];
  ...
  String get totalPrice {
    ...
    if (basketData != null) {
      if (deliveryPrice > 0) {
        result = (basketData!.total + deliveryPrice).toString();
      } else {
        result = basketData!.total.toString();
      }
    }
  ...
  Future<void> fetchRecomendedItems() async {
    ...
    if (basket != null) {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        setState(() {
          relatedData = localRelatedProduct;
        });
      }
    }
  }
  ...
  String get cashback {
    ...
    String result = '0';
    if (basketData != null) {
      result = (basketData!.total * 0.05).round().toString();
    }
        ...
        child: Stack(
          children: [
                    ...
                    return Column(
                      children: [
                        ...
                        ListView.separated(
                            ...
                            itemCount: basketData?.lines?.length ?? 0,
                            separatorBuilder: (context, index) {
                              return const Divider();
                            },
                            itemBuilder: (context, index) {
                              final item = basketData!.lines![index];
                                ...
                                child: SizedBox(
                                  ...
                                  child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        productPrice = relatedData[index].price;
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                    ...
                                    children: [
                                      Text(
                                        '${basketData?.lines?.length} ${tr("goods-amount")}:',
                                        style: const TextStyle(fontSize: 18),
                                      ),
                                      Text(
                                        productsTotalPrice,
            ...
            Positioned(
                ...
                child: Container(
                  color: Colors.white,
                  child: n.NikuButton.elevated(_isOrderLoading == true
