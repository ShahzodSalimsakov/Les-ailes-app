...
class WayToReceiveAnOrder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    builder: (context, box, _) {
      ...
      if (deliveryLocationData != null) {
        return n.NikuButton(Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
          Column(
            mainAxisAlignment: MainAxisAlignment.start,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
            Row(children: [
              deliveryType!.value == DeliveryTypeEnum.deliver ? Image.asset('images/delivery_car.png', width: 30, height: 15,) : Image.asset('images/delivery_pickup.png', width: 30, height: 15,),
              const SizedBox(width: 10),
              Text(tr(deliveryType.value.toString()))
            ],),
            const SizedBox(height: 10,),
            deliveryType!.value == DeliveryTypeEnum.deliver ? SizedBox(width: MediaQuery.of(context).size.width * 0.7,child:n.NikuText(deliveryText)) : n.NikuText(currentTerminal!.name)
          ],),
          const Icon(Icons.chevron_right, color: Colors.black, size: 30,)
        ],))..bg = Colors.grey.shade100..rounded = 20..p = 20;
      }
